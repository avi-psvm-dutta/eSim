...
class Application(QtGui.QMainWindow):
    ...
    def initToolBar(self):
        ...
        self.var = QtGui.QAction(QtGui.QIcon('../../images/osama.png'),'<b>Open Schematic</b>',self)
        self.var.triggered.connect(self.avi)
        ...
        self.lefttoolbar.addAction(self.var)
    ...
    def avi(self):
        print "Avi's button was pressed"
        self.obj_appconfig.print_info("Avi's button was pressed")
        self.obj_Mainview.obj_dockarea.avimessage()
